...
# --- 8. WEEKLY REPORT (V23.0 - FIX AFFICHAGE HTML) ---
def render_weekly_report(df_full_history):
    ...
    with c1:
        ...
        # --- CONSTRUCTION DU HTML SANS INDENTATION (CRUCIAL) ---
        # On construit la string Podium en une seule ligne pour éviter les blocs de code
        podium_html = ""
        medals = ["🥇", "🥈", "🥉"]
        ...
        # Analyse avec sauts de ligne HTML explicites
        ...
        # LE BLOC HTML FINAL (COLLÉ À GAUCHE)
        html_content = f"""
