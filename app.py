...
<style>
    ...
    /* STAT BOX MINI - AJUSTEMENT MARGES & PADDING */
    .stat-box-mini {{ 
        background: rgba(255,255,255,0.03); 
        border:1px solid rgba(255,255,255,0.05); 
        border-radius:12px; 
        padding: 25px 10px; /* Padding interne généreux */
        text-align:center; 
        height:100%; 
        display:flex; 
        flex-direction:column; 
        justify-content:center; 
        margin-bottom: 10px; /* Marge externe réduite pour resserrer la grille */
    }}
